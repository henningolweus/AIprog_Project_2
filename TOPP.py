...
class TOPP:
    ...
    def select_move_based_on_probabilities(self, legal_moves, move_probabilities, board_size):
        ...
        # Ensure no NaN values remain in the normalized probabilities
    ...
    def play_game_between_policies(self, policy1, policy2, current_player):
         # Play a game between two policies and return the winner
    ...
    def analyze_results(self, results):
        """Full analysis of result from finished TOPP tournament."""
